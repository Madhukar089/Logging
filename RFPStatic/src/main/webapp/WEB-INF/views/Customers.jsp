...
<body>
	...
	<section class="FilterDiv" style="background-color: #ADD8E6; padding: 20px;">
	  <form class="form-inline">
	    ...
	    <div class="form-group mr-3">
	      <label for="byStatus">ByName:</label>
	      <select class="form-control ml-2" id="byStatus">
	        <!-- Add options for ByStatus dropdown -->
	        <option selected disabled>choose Status</option>
	        <option value="inProgress">Name1</option>
	        <option value="completed">Name2</option>
	      </select>
	    </div>
	    <div class="form-group">
	      <label for="byDate">ByCompany:</label>
	      <select class="form-control ml-2" id="byDate">
	        <!-- Add options for ByDate dropdown -->
	        <option selected disabled>choose Date</option>
	        <option value="date1">Company 1</option>
	        <option value="date2">Company 2</option>
	        <option value="date3">Company 3</option>
	      </select>
	    </div>
	  </form>
	</section>
		  ...
		  <table class="table">
		    <thead>
		      <tr>
		        ...
		        <th scope="col">cust_Type</th>
		        <th scope="col">cust_name</th>
		        <th scope="col">cust_company</th>
		        <th scope="col">cust_address</th>
		        <th scope="col">cust_location</th>
		        <th scope="col">cust_mobile</th>
		        <th scope="col">cust_email</th>
		        <th scope="col">cust_website</th>
		        <th scope="col"></th>
		        <th scope="col"></th>
		      </tr>
		    </thead>
		    ...
		    <tbody>
		      <tr>
		        ...
		        <td>
				    <button class="btn btn-primary view-button" data-form="form3">Edit</button>
		        </td>
		        <td>
